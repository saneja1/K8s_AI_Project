...
def main():
    ...
    page = st.sidebar.radio(
        ...
        help="Choose between validating hosts, viewing VM status, or monitoring pods"
    )
...
def vm_status_page():
    """Display VM status and resource monitoring page."""
    ...
    with col1:
        st.markdown("### Real-time VM Monitoring")
    with col2:
...
def pod_monitor_page():
    """Display pod monitoring page."""
    st.markdown("## 📊 Pod Monitor")
    st.markdown("---")
